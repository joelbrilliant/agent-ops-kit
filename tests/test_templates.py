...
def test_config_template_validates_and_packaged_sandbox_denies_gui_execution():
    ...
    assert '(deny file-read-data file-write* (subpath "/Users/openclaw/Projects"))' in sandbox
    assert '(allow file-read-data (literal "/Users/openclaw/Projects"))' in sandbox
    assert '(allow file-read-data (literal "/Users/openclaw/Projects/FILESYSTEM.md"))' in sandbox
